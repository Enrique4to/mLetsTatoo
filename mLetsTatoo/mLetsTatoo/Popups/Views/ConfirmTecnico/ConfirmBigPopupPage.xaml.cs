...
namespace mLetsTatoo.Popups.Views
{
	...
	public partial class ConfirmBigPopupPage : PopupPage
	{
        #region Attributes
        private int time;
        ...
        public async void GetImage(object sender, EventArgs e)
        {
            ...
            {
                MainViewModel.GetInstance().ConfirmTecnicoPopup.file7 = this.file;
            }
            else if (imageSender == this.BMImage)
            {
                MainViewModel.GetInstance().ConfirmTecnicoPopup.file8 = this.file;
            }
            else if (imageSender == this.BHImage)
            {
                MainViewModel.GetInstance().ConfirmTecnicoPopup.file9 = this.file;
            }
        }
        public async void GetTime(object sender, EventArgs e)
        {
            ...
            {
                MainViewModel.GetInstance().ConfirmTecnicoPopup.BETime = this.time;
            }
            else if (timeSender == this.BMTime)
            {
                MainViewModel.GetInstance().ConfirmTecnicoPopup.BMTime = this.time;
            }
            else if (timeSender == this.BHTime)
            {
                MainViewModel.GetInstance().ConfirmTecnicoPopup.BHTime = this.time;
            }
        }
