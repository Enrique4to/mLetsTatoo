...
namespace mLetsTatoo.Popups.Views
{
	...
	public partial class EditMediumPopupPage : PopupPage
	{
        #region Attributes
        private int time;
        ...
        public async void GetImage(object sender, EventArgs e)
        {
            ...
            if (source == Languages.Cancel)
            {
                ...
                {
                    MainViewModel.GetInstance().EditFeaturesPopup.FME.Imagen_Ejemplo = MainViewModel.GetInstance().EditFeaturesPopup.FME.Imagen_Ejemplo;
                }
                else if (imageSender == this.MMImage)
                {
                    MainViewModel.GetInstance().EditFeaturesPopup.FMM.Imagen_Ejemplo = MainViewModel.GetInstance().EditFeaturesPopup.FMM.Imagen_Ejemplo;
                }
                else if (imageSender == this.MHImage)
                {
                    MainViewModel.GetInstance().EditFeaturesPopup.FMH.Imagen_Ejemplo = MainViewModel.GetInstance().EditFeaturesPopup.FMH.Imagen_Ejemplo;
                }
                return;
            }
            ...
            if (imageSender == this.MEImage)
            {
                MainViewModel.GetInstance().EditFeaturesPopup.FME.Imagen_Ejemplo = FileHelper.ReadFully(this.file.GetStream());
            }
            else if (imageSender == this.MMImage)
            {
                MainViewModel.GetInstance().EditFeaturesPopup.FMM.Imagen_Ejemplo = FileHelper.ReadFully(this.file.GetStream());
            }
            else if (imageSender == this.MHImage)
            {
                MainViewModel.GetInstance().EditFeaturesPopup.FMH.Imagen_Ejemplo = FileHelper.ReadFully(this.file.GetStream());
            }
        }
        public async void GetTime(object sender, EventArgs e)
        {
            ...
            {
                MainViewModel.GetInstance().EditFeaturesPopup.FME.Tiempo = this.time;
            }
            else if (timeSender == this.MMTime)
            {
                MainViewModel.GetInstance().EditFeaturesPopup.FMM.Tiempo = this.time;
            }
            else if (timeSender == this.MHTime)
            {
                MainViewModel.GetInstance().EditFeaturesPopup.FMH.Tiempo = this.time;
            }
        }
